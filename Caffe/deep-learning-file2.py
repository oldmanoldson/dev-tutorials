...
def deploy(img_path):
    ...
    net = caffe.Classifier('/dli/data/digits/20190426-183929-9c33/deploy.prototxt', '/dli/data/digits/20190426-183929-9c33/snapshot_iter_270.caffemodel',
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256, 256))
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20190426-183804-38bb/mean.jpg')
