...
# Create synthetic sales data for monte carlo testing
avg = 1
std_dev = 0.1
num_reps = 500
...
df['Commission_Rate'] = df['Pct_To_Target'].apply(calc_commission_rate) # .apply() applies the function values from above
